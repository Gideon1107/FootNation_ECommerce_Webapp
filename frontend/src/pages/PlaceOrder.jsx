      ...
      {/* ---------------------- Left Side --------------------- */}
        <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
          ...
          <div className='flex gap-3'>
            ...
            <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type="text" placeholder='County'/>
          </div>
          <div className='flex gap-3'>
            <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Postcode'/>
            <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Country'/>
          </div>
          <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Phone'/>
        </div>
