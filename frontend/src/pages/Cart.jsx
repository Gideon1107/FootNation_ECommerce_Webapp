...
const Cart = () => {
  ...
  const { products, currency, getCartCount, cartItems, updateQuantity, navigate } = useContext(ShopContext);
  ...
  return (
    <div className='border-t pt-14'>
      <div className='text-2xl mb-3'>
        <Title text1={'MY'} text2={'BAG'} /> <span className='text-l'>({getCartCount()})</span>
      </div>
                ...
                <div className=' flex items-start gap-6' >
                  ...
                  <div>
                    ...
                    <div className='flex items-center gap-5 mt-2'>
                      ...
                      <span>|</span>
                      <p className='px-1 sm:px-2 sm:py-1 text-l'>size: {item.size}</p>
                    </div>
                  </div>
                </div>
